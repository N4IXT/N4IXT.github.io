...
Tell me about the victor victrola model vv4-3. Format the output as html. Format the name of the radio as an h2 tag at the very top. Under it, include the years of production at the top, in h3, labeled as "Years of Production: ". Then add then other information below it, such as technical specifications, notable features, and historical context plus any other details. I only need the code for the body area, you can omit the other areas outside the body. Include information on how this victrola predates the victor company by RCA. Mention how RCA obtained the logo of the dog listening to the record player, often referred to as his masters voice.
